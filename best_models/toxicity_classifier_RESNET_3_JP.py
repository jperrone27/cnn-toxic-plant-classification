...
run_model_ResNet50(x_train, y_train, x_test, y_test, img_res, 50, validation= val_tuple, optim= optim, batch= batch , log_file_no='ResNet50_3', color = color2, unfrozen = unfrz, dropout = drop)
