...
run_model_InceptionV3(x_train, y_train, x_test, y_test, img_res, 100, validation= val_tuple, optim= optim, batch = batch , log_file_no='InceptionV3_5', color = color2, unfrozen = unfrz, dropout = drop)
